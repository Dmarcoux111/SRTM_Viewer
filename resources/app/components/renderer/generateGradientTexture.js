...
const gradients = {
  0: [ [ 0.0, new THREE.Color( .957, .263, .212 ) ] ],
  1: [ [ 0.0, new THREE.Color( .298, .686, .314 ) ] ],
  2: [ [ 0.0, new THREE.Color( .129, .588, .953 ) ] ],
  3: [ [ 0.0, new THREE.Color( 1.0, .922, .231 ) ] ],
  4: [ [ 0.0, new THREE.Color( 1.0, .596, 0 ) ] ],
  5: [ [ 0.0, new THREE.Color( .612, .153, .690 ) ] ],
  6: [ [ 0.0, new THREE.Color( .914, .118, .388 ) ] ],
  7: [ [ 0.0, new THREE.Color( .475, .333, .282 ) ] ],
  RAINBOW: [
  ...
  EARTH_TONES: [
    [ 0.0, new THREE.Color( 0.360, 0.443, 0.333 ) ],
    [ 0.1, new THREE.Color( 0.620, 0.722, 0.404 ) ],
    [ 0.2, new THREE.Color( 0.808, 0.859, 0.506 ) ],
    [ 0.3, new THREE.Color( 0.882, 0.882, 0.573 ) ],
    [ 0.4, new THREE.Color( 0.906, 0.851, 0.518 ) ],
    [ 0.5, new THREE.Color( 0.718, 0.561, 0.329 ) ],
    [ 0.6, new THREE.Color( 0.624, 0.416, 0.235 ) ],
    [ 0.7, new THREE.Color( 0.651, 0.494, 0.361 ) ],
    [ 0.8, new THREE.Color( 0.678, 0.576, 0.490 ) ],
    [ 0.986, new THREE.Color( 0.706, 0.655, 0.620 ) ],
    [ 1.0, new THREE.Color( 0.863, 0.863, 0.863 ) ],
  ],
  SPECTRAL: [
  ...
  ICE: [
    ...
    [ 0.05, new THREE.Color( 0.1338, 0.3555, 0.4227 ) ],
    [ 0.2, new THREE.Color( 0.0610, 0.4319, 0.4864 ) ],
    [ 0.3, new THREE.Color( 0.0000, 0.5099, 0.5319 ) ],
    [ 0.4, new THREE.Color( 0.0000, 0.5881, 0.5569 ) ],
    [ 0.5, new THREE.Color( 0.1370, 0.6650, 0.5614 ) ],
    [ 0.6, new THREE.Color( 0.2906, 0.7395, 0.5477 ) ],
    [ 0.99, new THREE.Color( 0.4453, 0.8099, 0.5201 ) ],
    [ 1.0, new THREE.Color( 0.360, 0.443, 0.333 ) ],
  ],
  GRAYSCALE: [
    [ 0, new THREE.Color( 0, 0, 0 ) ],
