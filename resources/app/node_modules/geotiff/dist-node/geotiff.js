...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=a(require("txml")),e=require("./globals"),r=require("./rgb"),i=require("./compression"),o=require("./resample");function a(t){return t&&t.__esModule?t:{default:t}}function s(t,e,r){let i=0;for(let o=e;o<r;++o)i+=t[o];return i}function l(t,e,r){switch(t){case 1:switch(e){case 8:return new Uint8Array(r);case 16:return new Uint16Array(r);case 32:return new Uint32Array(r)}break;case 2:switch(e){case 8:return new Int8Array(r);case 16:return new Int16Array(r);case 32:return new Int32Array(r)}break;case 3:switch(e){case 32:return new Float32Array(r);case 64:return new Float64Array(r)}}throw Error("Unsupported data format/bitsPerSample")}class n{constructor(t,e,r,i,o,a){this.fileDirectory=t,this.geoKeys=e,this.dataView=r,this.littleEndian=i,this.tiles=o?{}:null,this.isTiled=!t.StripOffsets;const s=t.PlanarConfiguration;if(this.planarConfiguration=void 0===s?1:s,1!==this.planarConfiguration&&2!==this.planarConfiguration)throw new Error("Invalid planar configuration.");this.source=a}getFileDirectory(){return this.fileDirectory}getGeoKeys(){return this.geoKeys}getWidth(){return this.fileDirectory.ImageWidth}getHeight(){return this.fileDirectory.ImageLength}getSamplesPerPixel(){return this.fileDirectory.SamplesPerPixel}getTileWidth(){return this.isTiled?this.fileDirectory.TileWidth:this.getWidth()}getTileHeight(){return this.isTiled?this.fileDirectory.TileLength:void 0!==this.fileDirectory.RowsPerStrip?Math.min(this.fileDirectory.RowsPerStrip,this.getHeight()):this.getHeight()}getBytesPerPixel(){let t=0;for(let e=0;e<this.fileDirectory.BitsPerSample.length;++e){const r=this.fileDirectory.BitsPerSample[e];if(r%8!=0)throw new Error(`Sample bit-width of ${r} is not supported.`);if(r!==this.fileDirectory.BitsPerSample[0])throw new Error("Differing size of samples in a pixel are not supported.");t+=r}return t/8}getSampleByteSize(t){if(t>=this.fileDirectory.BitsPerSample.length)throw new RangeError(`Sample index ${t} is out of range.`);const e=this.fileDirectory.BitsPerSample[t];if(e%8!=0)throw new Error(`Sample bit-width of ${e} is not supported.`);return e/8}getReaderForSample(t){const e=this.fileDirectory.SampleFormat?this.fileDirectory.SampleFormat[t]:1,r=this.fileDirectory.BitsPerSample[t];switch(e){case 1:switch(r){case 8:return DataView.prototype.getUint8;case 16:return DataView.prototype.getUint16;case 32:return DataView.prototype.getUint32}break;case 2:switch(r){case 8:return DataView.prototype.getInt8;case 16:return DataView.prototype.getInt16;case 32:return DataView.prototype.getInt32}break;case 3:switch(r){case 32:return DataView.prototype.getFloat32;case 64:return DataView.prototype.getFloat64}}throw Error("Unsupported data format/bitsPerSample")}getArrayForSample(t,e){return l(this.fileDirectory.SampleFormat?this.fileDirectory.SampleFormat[t]:1,this.fileDirectory.BitsPerSample[t],e)}async getTileOrStrip(t,e,r,i){const o=Math.ceil(this.getWidth()/this.getTileWidth()),a=Math.ceil(this.getHeight()/this.getTileHeight());let s;const{tiles:l}=this;let n,h;1===this.planarConfiguration?s=e*o+t:2===this.planarConfiguration&&(s=r*o*a+e*o+t),this.isTiled?(n=this.fileDirectory.TileOffsets[s],h=this.fileDirectory.TileByteCounts[s]):(n=this.fileDirectory.StripOffsets[s],h=this.fileDirectory.StripByteCounts[s]);const c=await this.source.fetch(n,h);let p;return null===l?p=i.decode(this.fileDirectory,c):l[s]||(p=i.decode(this.fileDirectory,c),l[s]=p),{x:t,y:e,sample:r,data:await p}}async _readRaster(t,e,r,i,a,l,n,h){const c=this.getTileWidth(),p=this.getTileHeight(),f=Math.max(Math.floor(t[0]/c),0),g=Math.min(Math.ceil(t[2]/c),Math.ceil(this.getWidth()/this.getTileWidth())),u=Math.max(Math.floor(t[1]/p),0),m=Math.min(Math.ceil(t[3]/p),Math.ceil(this.getHeight()/this.getTileHeight())),d=t[2]-t[0];let y=this.getBytesPerPixel();const w=[],D=[];for(let o=0;o<e.length;++o)1===this.planarConfiguration?w.push(s(this.fileDirectory.BitsPerSample,0,e[o])/8):w.push(0),D.push(this.getReaderForSample(e[o]));const M=[],{littleEndian:S}=this;for(let o=u;o<m;++o)for(let s=f;s<g;++s)for(let l=0;l<e.length;++l){const n=l,h=e[l];2===this.planarConfiguration&&(y=this.getSampleByteSize(h));const f=this.getTileOrStrip(s,o,h,a);M.push(f),f.then(o=>{const a=o.data,s=new DataView(a),l=o.y*p,h=o.x*c,f=(o.y+1)*p,g=(o.x+1)*c,u=D[n],m=Math.min(p,p-(f-t[3])),M=Math.min(c,c-(g-t[2]));for(let p=Math.max(0,t[1]-l);p<m;++p)for(let o=Math.max(0,t[0]-h);o<M;++o){const a=(p*c+o)*y,f=u.call(s,a+w[n],S);let g;i?(g=(p+l-t[1])*d*e.length+(o+h-t[0])*e.length+n,r[g]=f):(g=(p+l-t[1])*d+o+h-t[0],r[n][g]=f)}})}if(await Promise.all(M),l&&t[2]-t[0]!==l||n&&t[3]-t[1]!==n){let a;return(a=i?(0,o.resampleInterleaved)(r,t[2]-t[0],t[3]-t[1],l,n,e.length,h):(0,o.resample)(r,t[2]-t[0],t[3]-t[1],l,n,h)).width=l,a.height=n,a}return r.width=l||t[2]-t[0],r.height=n||t[3]-t[1],r}async readRasters({window:t,samples:e=[],interleave:r,pool:o=null,width:a,height:s,resampleMethod:n,fillValue:h}={}){const c=t||[0,0,this.getWidth(),this.getHeight()];if(c[0]>c[2]||c[1]>c[3])throw new Error("Invalid subsets");const p=(c[2]-c[0])*(c[3]-c[1]);if(e&&e.length){for(let i=0;i<e.length;++i)if(e[i]>=this.fileDirectory.SamplesPerPixel)return Promise.reject(new RangeError(`Invalid sample index '${e[i]}'.`))}else for(let i=0;i<this.fileDirectory.SamplesPerPixel;++i)e.push(i);let f;if(r){f=l(this.fileDirectory.SampleFormat?Math.max.apply(null,this.fileDirectory.SampleFormat):1,Math.max.apply(null,this.fileDirectory.BitsPerSample),p*e.length),h&&f.fill(h)}else{f=[];for(let t=0;t<e.length;++t){const r=this.getArrayForSample(e[t],p);Array.isArray(h)&&t<h.length?r.fill(h[t]):h&&!Array.isArray(h)&&r.fill(h),f.push(r)}}const g=o||(0,i.getDecoder)(this.fileDirectory);return await this._readRaster(c,e,f,r,g,a,s,n)}async readRGB({window:t,pool:i=null,width:o,height:a,resampleMethod:s,enableAlpha:l=!1}={}){const n=t||[0,0,this.getWidth(),this.getHeight()];if(n[0]>n[2]||n[1]>n[3])throw new Error("Invalid subsets");const h=this.fileDirectory.PhotometricInterpretation;if(h===e.photometricInterpretations.RGB){let r=[0,1,2];if(this.fileDirectory.ExtraSamples!==e.ExtraSamplesValues.Unspecified&&l){r=[];for(let t=0;t<this.fileDirectory.BitsPerSample.length;t+=1)r.push(t)}return this.readRasters({window:t,interleave:!0,samples:r,pool:i,width:o,height:a})}let c;switch(h){case e.photometricInterpretations.WhiteIsZero:case e.photometricInterpretations.BlackIsZero:case e.photometricInterpretations.Palette:c=[0];break;case e.photometricInterpretations.CMYK:c=[0,1,2,3];break;case e.photometricInterpretations.YCbCr:case e.photometricInterpretations.CIELab:c=[0,1,2];break;default:throw new Error("Invalid or unsupported photometric interpretation.")}const p={window:n,interleave:!0,samples:c,pool:i,width:o,height:a,resampleMethod:s},{fileDirectory:f}=this,g=await this.readRasters(p),u=2**this.fileDirectory.BitsPerSample[0];let m;switch(h){case e.photometricInterpretations.WhiteIsZero:m=(0,r.fromWhiteIsZero)(g,u);break;case e.photometricInterpretations.BlackIsZero:m=(0,r.fromBlackIsZero)(g,u);break;case e.photometricInterpretations.Palette:m=(0,r.fromPalette)(g,f.ColorMap);break;case e.photometricInterpretations.CMYK:m=(0,r.fromCMYK)(g);break;case e.photometricInterpretations.YCbCr:m=(0,r.fromYCbCr)(g);break;case e.photometricInterpretations.CIELab:m=(0,r.fromCIELab)(g);break;default:throw new Error("Unsupported photometric interpretation.")}return m.width=g.width,m.height=g.height,m}getTiePoints(){if(!this.fileDirectory.ModelTiepoint)return[];const t=[];for(let e=0;e<this.fileDirectory.ModelTiepoint.length;e+=6)t.push({i:this.fileDirectory.ModelTiepoint[e],j:this.fileDirectory.ModelTiepoint[e+1],k:this.fileDirectory.ModelTiepoint[e+2],x:this.fileDirectory.ModelTiepoint[e+3],y:this.fileDirectory.ModelTiepoint[e+4],z:this.fileDirectory.ModelTiepoint[e+5]});return t}getGDALMetadata(e=null){const r={};if(!this.fileDirectory.GDAL_METADATA)return null;const i=this.fileDirectory.GDAL_METADATA,o=(0,t.default)(i.substring(0,i.length-1));if(!o[0].tagName)throw new Error("Failed to parse GDAL metadata XML.");const a=o[0];if("GDALMetadata"!==a.tagName)throw new Error("Unexpected GDAL metadata XML tag.");let s=a.children.filter(t=>"Item"===t.tagName);null!==e&&(s=s.filter(t=>Number(t.attributes.sample)===e));for(let t=0;t<s.length;++t){const e=s[t];r[e.attributes.name]=e.children[0]}return r}getGDALNoData(){if(!this.fileDirectory.GDAL_NODATA)return null;const t=this.fileDirectory.GDAL_NODATA;return Number(t.substring(0,t.length-1))}getOrigin(){const t=this.fileDirectory.ModelTiepoint,e=this.fileDirectory.ModelTransformation;if(t&&6===t.length)return[t[3],t[4],t[5]];if(e)return[e[3],e[7],e[11]];throw new Error("The image does not have an affine transformation.")}getResolution(t=null){const e=this.fileDirectory.ModelPixelScale,r=this.fileDirectory.ModelTransformation;if(e)return[e[0],-e[1],e[2]];if(r)return[r[0],r[5],r[10]];if(t){const[e,r,i]=t.getResolution();return[e*t.getWidth()/this.getWidth(),r*t.getHeight()/this.getHeight(),i*t.getWidth()/this.getWidth()]}throw new Error("The image does not have an affine transformation.")}pixelIsArea(){return 1===this.geoKeys.GTRasterTypeGeoKey}getBoundingBox(){const t=this.getOrigin(),e=this.getResolution(),r=t[0],i=t[1],o=r+e[0]*this.getWidth(),a=i+e[1]*this.getHeight();return[Math.min(r,o),Math.min(i,a),Math.max(r,o),Math.max(i,a)]}}var h=n;exports.default=h;
